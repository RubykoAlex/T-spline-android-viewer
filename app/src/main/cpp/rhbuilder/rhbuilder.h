...
public:
	...
	RhBuilder(const string &filename,  std::istream *fin);
	~RhBuilder();
...
private:
	...
	string vId(int id) { string s = "v" + patch::to_string((long long)id); return s; }
	/** Create edge name by id. */
	string eId(int id) { string s = "e" + patch::to_string((long long)id); return s; }
	/** Create link name by id. */
	string lId(int id) { string s = "l" + patch::to_string((long long)id); return s; }
	/** Create edge condition name by id. */
	string ecId(int id) { string s = "ec" + patch::to_string((long long)id); return s; }
	/** Create face name by id. */
	string fId(int id) { string s = "f" + patch::to_string((long long)id); return s; }
	/** Create node name by id. */
	string nId(int id) { string s = "n" + patch::to_string((long long)id); return s; }
	/** Create point name by id. */
	string pId(int id) { string s = "p" + patch::to_string((long long)id); return s; }
private:
	RhParserPtr _parser;
