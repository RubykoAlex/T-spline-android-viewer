...
public:
	...
	virtual Real width(){ return 0.0;};
	/** Height of the T-mapper. */
	virtual Real height() {return 0.0;};
	/** Area of the T-mapper. */
	virtual Real area() {return 0.0;};
...
public:
	...
	void findNorthLinks(TLnkVector &links)const;
	...
	void findEastLinks(TLnkVector &links)const;
