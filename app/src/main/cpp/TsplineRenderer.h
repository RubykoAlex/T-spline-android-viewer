...
//--------------------------------------------------------------------------------
#ifndef _TSPLINERENDERER_H
#define _TSPLINERENDERER_H
...
#define APPLICATION_CLASS_NAME "alex/t_spline/t_spline/TsplineApplication"
