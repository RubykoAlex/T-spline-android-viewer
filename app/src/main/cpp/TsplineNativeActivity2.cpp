...
#define HELPER_CLASS_NAME \
  "alex/t_spline/helper/NDKHelper"  // Class name of helper function
...
Java_alex_t_1spline_t_1spline_TsplineNativeActivity_stringFromJNI(JNIEnv* env, jstring z) {
...
void android_main(android_app* state) {
  ...
  monstartup("libTsplineNativeActivity2.so");
#endif
