...
public class TsplineNativeActivity extends NativeActivity {
   ...
   // }
    ...
    public void onBackPressed() {
        super.onBackPressed();
        finish();
        Intent myIntent = new Intent(TsplineNativeActivity.this, MainActivity.class);
    ...
    TsplineNativeActivity _activity;
